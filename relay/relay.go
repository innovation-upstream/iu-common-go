...
func AuthorizeGCPContext(ctx context.Context, addr string) (context.Context, error) {
...
func DialRPCService(ctx context.Context, rpcEndpoint string, tracer trace.Tracer) (context.Context, *grpc.ClientConn, error) {
