...
go_repository(
    ...
    sum = "h1:iGu644GcxtEcrInvDsQRCwJjtCIOlT2V7IRt6ah2Whw=",
    version = "v0.0.0-20210423185535-09eb48e85fd7",
)
...
go_repository(
    ...
    sum = "h1:TYqOq/v+Ri5aADpldxXOj6PmvcPMOJbLjdALzZDQT2M=",
    version = "v0.0.0-20201202200335-bef1c476418a",
)
